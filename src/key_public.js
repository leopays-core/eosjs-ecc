...
*/
function PublicKey(Q, pubkey_prefix = 'LPC') {
    if(typeof Q === 'string') {
    ...
    */
    function toString(pubkey_prefix = 'LPC') {
...
/**
  ...
  @param {string} [pubkey_prefix = 'LPC']
*/
PublicKey.isValid = function(pubkey, pubkey_prefix = 'LPC') {
    try {
...
*/
PublicKey.fromString = function(public_key, pubkey_prefix = 'LPC') {
    try {
...
/**
    ...
    @return PublicKey
*/
PublicKey.fromStringOrThrow = function(public_key, pubkey_prefix = 'LPC') {
