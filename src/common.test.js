...
describe('Common API', () => {
  ...
  it('privateToPublic', () => {
    ...
    const pub = 'LPC859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM'
  ...
  it('isValidPublic', () => {
    const keys = [
      ...
      [true, 'LPC859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM'],
      [false, 'MMM859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM'],
      [false, 'LPC859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVm', 'LPC'],
